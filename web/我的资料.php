    ...
    <form action="../PHP/ten_postInfo.php" method="post">
        ...
        <div class="sex_box">
            <p class="sex_text">性别</p>
                <input name="sex" type="radio" value="男" <?php if($info['tn_sex'] == '男'){?> checked <?php }?> style="margin-top: 5px;margin-left: 90px;"/><label>男&nbsp;&nbsp;</label>
                <input name="sex" type="radio" value="女" <?php if($info['tn_sex'] == '女'){?> checked <?php }?>/><label>女</label>
        </div>
        <!-- 手机号 -->
