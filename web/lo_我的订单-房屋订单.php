...
<body>
    ...
    <?php 
        ...
        if(mysqli_num_rows($result)){
            ...
            $res = mysqli_query($conn, $search);//res找到房客租的房子记录
        }
        else{
            die("未找到有效用户！");
        }
    ...
    <header class="head" id="head">
        ...
        <!-- logo -->
        <div class="logo_box">
            <a href="lo_租房.php" style="color: white;"><p>租立方</p></a>
        </div>

        <!-- 顶部导航 -->
        <div class="nav_box">
            <a href="lo_我的资料.php"><span class="message_title">我的资料</span></a>
    ...
    <section class="oder_box">
        <div class="title">
            <a href="#"><span class="house_title">房屋订单<br><br><br></span></a>
            <a href="我的订单-服务订单.php"><span class="service_title">服务订单</span></a>
