...
<body>
    ...
    <section class="select_box">
        <div class="address_box">
            ...
            <form>
                <input type="radio" name="address" value="address1" style="margin-top: 20px;margin-left: 87px;"/><label>不限&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
        ...
        <div class="type_box">
            ...
            <form>
                <input type="radio" name="type" value="type1" style="margin-top: 20px;margin-left: 87px;"/><label>不限&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                <input name="type" type="radio" value="type2"/><label>合租&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                <input name="type" type="radio" value="type3"/><label>整租&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                <input checked name="type" type="radio" value="type4"/><label>公寓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
        ...
        <div class="unit_box">
            ...
            <form>
                <input type="radio" name="unit" value="unit1" style="margin-top: 20px;margin-left: 87px;"/><label>不限&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                <input name="unit" type="radio" value="unit2"/><label>一室一厅&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                <input checked name="unit" type="radio" value="unit3"/><label>两室一厅&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
        ...
        <div class="area_box">
            ...
            <form>
                ...
                <input type="radio" name="area" value="area1" style="margin-top: 20px;margin-left: 87px;"/><label>不限&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
        ...
        <div class="style_box">
            ...
            <form>
                <input type="radio" name="style" value="style1" style="margin-top: 20px;margin-left: 50px;"/><label>不限&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                <input name="style" type="radio" value="style2"/><label>精装修&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                <input name="style" type="radio" value="style3"/><label>粗装修&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                <input checked name="style" type="radio" value="style4"/><label>ins风格&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
        ...
        <div class="sumit_button">
            <input type="button" name="sumit"  value="筛选房屋" style="border: 0;background-color: #826D6D; color: white;font-size: 13px; width: 120px;height: 30px;">
        </div>
    </section>
    ...
    <a href="房屋详情.html"><div class="house1">
        <div class="house_photo">
            <a href="房屋详情.php"><img src="../web/coverage/房屋详情图1.jpg" alt="some_text" width="100%" height="180px" style="border-radius: 15px 15px 0 0;"></a>
        </div>
        <div class="big_title">
            <span class="house_title">幸福花园的二居室</span>
            <span class="price">¥1500/月</span>
        </div>
        <p class="area_unit">65m²  |  两室一厅</p>
        <p class="address_title">惠城区河南岸演达大道金山湖路34号</p>
    </div></a>

    <div class="house2">
        <div class="house_photo">
            <a href="房屋详情.php"><img src="../web/coverage/房屋图3.jpg" alt="some_text" width="100%" height="180px" style="border-radius: 0px 15px 0 0;"></a>
        </div>
        <div class="big_title">
            <span class="house_title">图图乐园的大别墅</span>
            <span class="price">¥5000/月</span>
        </div>
        <p class="area_unit">412m²  |  四室两厅</p>
        <p class="address_title">博罗县富贵大道府前路7号</p>
    </div>

    <div class="house3">
        <div class="house_photo">
            <a href="房屋详情.php"><img src="../web/coverage/房屋图4.jpg" alt="some_text" width="100%" height="180px" style="border-radius: 15px 15px 0 0;"></a>
        </div>
        <div class="big_title">
            <span class="house_title">颐景佳园的三居室</span>
            <span class="price">¥2000/月</span>
        </div>
        <p class="area_unit">98m²  |  三室两厅</p>
